...
import gabo from "/img/gabo.jpeg";

const Section1 = () => {
    return (
        <section id="home" className="flex flex-col justify-center items-center min-h-[100svh] w-full gap-8 pt-12 md:pt-24">
            <div style={{ backgroundImage: `url('${gabo}')`}} className="w-64 h-64 bg-[length:100%] bg-center rounded-full border-2 border-white transition-all duration-300 ease-in-out shadow-[0px_0px_32px_8px_rgba(59,_130,_246,_0.5)] hover:-translate-y-4 hover:shadow-[0px_0px_48px_8px_rgba(59,_130,_246,_0.75)] hover:bg-[length:150%]"></div>
