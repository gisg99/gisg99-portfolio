...
const Section2 = () => {
    return (
        <section id="about-me" className="flex flex-col justify-center items-center min-h-screen w-full gap-16 pt-24">
            <h1 className='poppins font-medium'>About me</h1>
            <div className="grid grid-cols-[400px_1fr] w-full h-full gap-12">
                <img src='/public/img/gabo5.png' alt="Gabriel Sánchez" className="rounded-md shadow-[-16px_16px_0px_0px_#485DD8]" />
